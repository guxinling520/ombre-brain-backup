...
9. 原文中的时间标记（如 `## 00:46`、`## 02:31`、`09:00-11:30`）必须保留到对应条目的 name 或 content 开头，格式如 "[09:00] 事件描述"
10. 日期也要保留：原文开头的 `## YYYY-MM-DD 日记` 中的日期，必须以 `YYYY-MM-DD` 格式出现在每个条目的 content 开头，如 "2026-06-24 [00:46] ..."
